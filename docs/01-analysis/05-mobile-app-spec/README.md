...
Техническое задание описывает целевое поведение Expo-клиента по согласованным требованиям, дизайн-брифам и OpenAPI 1.1. Это источник для реализации и тест-дизайна, но не утверждение, что текущее приложение уже соответствует каждому пункту.
