...
|---|---|---|---|---|---|
| BR-001 Самообслуживание записи | US-01–US-03; UC-01 | FR-001–FR-008; NFR-001–NFR-003, NFR-007, NFR-009 | SCR-001; CMP-001; BS-001; LOGIC-001–LOGIC-003, LOGIC-007 | TC-001–TC-010, TC-017–TC-019, TC-023 | Частично: нет полной обработки error/retry и измерения производительности |
...
| BR-006 Граница учебного MVP | US-03–US-05; UC-01–UC-03 | FR-015, FR-016; NFR-011 | SCR-001–SCR-003 | TC-024 | Частично: клиентская граница соблюдена, защищённый FastAPI ещё отсутствует |
...
| FR-015 Dev-идентификация | US-03–US-05; UC-01–UC-03 | Все защищённые сценарии | Все операции кроме чтения классов | `HttpStudioApi.getAccessToken` | — | `a3c5ae1` | Не покрыто: provider опционален, нет проверки `401` и backend |
...
| NFR-010 Сквозная проверяемость Must | Все Must | Эта матрица и канонические ссылки в `test-cases.md` | TC-001–TC-024 | TASK-021 | Частично: связи созданы, но часть Must пока без теста |
| NFR-011 Граница учебной auth | BR-006; US-03–US-05; UC-01–UC-03 | Bearer header поддержан; `.env` исключён | — | `a3c5ae1`, `0a4ef79` | Не покрыто: нет обязательного токена, `401`-теста и backend |
