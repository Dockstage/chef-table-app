...
1. Mock API разрешал повторную активную бронь — исправлено в `3e637dc`.
2. Отменённый студией класс возвращал `SLOT_FULL` вместо `SLOT_CANCELLED` — исправлено в `54e1b19`.
